...
public class UserDaoImpl implements UserDao {
	...
	public Long insert (User user) {
		...
		SimpleJdbcInsert jdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("user").usingGeneratedKeyColumns("user_id");
	...
	public Integer update(User user) {
		...
		return this.jdbcTemplate.update(
				"update user set name = ?, age =? values where user_id = ?",
